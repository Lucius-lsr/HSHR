...
feature_and_coordinate_dir = '/home2/lishengrui/tcga_result/all_tcga'
...
if __name__ == '__main__':
    ...
    model = get_moco(Layer(feature_in, feature_out), Layer(feature_in, feature_out), device, feature_out)
